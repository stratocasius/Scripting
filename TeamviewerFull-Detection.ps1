### Teamviewer Full 15.55.3.0 detection script - 10/31/2024
# Define the target DisplayName and minimum required version
$targetDisplayName = "TeamViewer"
$minVersion = "15.55.3.0"
...
if ($appDetected) {
    Write-Output "Teamviewer(Full) 15.55.3.0 installer detected version 15.55.3.0 or higher installed on $env:COMPUTERNAME."
    exit 0 # Success, application is installed
} else {
    Write-Output "Teamviewer(Full) 15.55.3.0 installer detected Teamviewer installed version is too low and Teamviewer Host 15.55.3.0 will be installed."
