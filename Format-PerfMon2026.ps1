...
try {
    ...
    $worksheet.Range("B2:EB724").NumberFormat = "0.00"
    ...
    $worksheet.Range("B724:EB724").Value2 = $worksheet.Range("B723:EB723").Value2

    # Format row 724
    $row724 = $worksheet.Range("A724:EB724")
    $row724.Font.Bold = $true
    $row724.Interior.Color = 16118015

    $worksheet.Columns("A:EB").AutoFit()
