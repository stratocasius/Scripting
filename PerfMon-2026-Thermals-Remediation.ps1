...
<DataCollectorSet>
	...
	<PerformanceCounterDataCollector>
		...
		<Counter>\Thermal Zone Information(*)\Temperature</Counter>
		<Counter>\Thermal Zone Information(*)\High Precision Temperature</Counter>
		<Counter>\Thermal Zone Information(*)\% Passive Limit</Counter>
		<Counter>\Thermal Zone Information(*)\Throttle Reasons</Counter>
