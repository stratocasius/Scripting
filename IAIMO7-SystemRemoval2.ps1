...
New keys to remove
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Office\16.0\User Settings\LexisNexis.InterAction.Outlook.AddIn

Remove from AV exclusion string/profile.
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\PolicyManager\providers\E3A46395-74F1-48AE-B826-C860868489AC\default\Device\Defender
AttackSurfaceReductionOnlyExclusions 

Check these out:
HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Provisioning\NodeCache\CSP\