### 08/14/2023 - Updated processes and analysis of key hardware components - Citrix-JabraDirect replaced Netskope-Rapid7.
$collectorSetXml = @"
...
<DataCollectorSet>
	...
	<PerformanceCounterDataCollector>
		...
		<LatestOutputLocation>C:\programdata\Microsoft\IntuneManagementExtension\Logs\DataCollector01.blg</LatestOutputLocation>
		<DataSourceName>
		</DataSourceName>
...
$logmanCommand = "logman import -n JL-Process-HW-Stats -xml C:\jltools\JL-Process-HardwareAnalysis.xml"
Invoke-Expression $logmanCommand

# Start the data collection process using the JL-Process-HW-Stats2 data collector set
$logmanCommand = "logman start JL-Process-HW-Stats3"
Invoke-Expression $logmanCommand
