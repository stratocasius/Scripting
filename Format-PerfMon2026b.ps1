...
try {
    ...
    $worksheet.Range("B2:EL724").NumberFormat = "0.00"
    ...
    $worksheet.Range("B724:EL724").Value2 = $worksheet.Range("B723:EL723").Value2

    # Format row 724
    $row724 = $worksheet.Range("A724:EL724")
    $row724.Font.Bold = $true
    $row724.Interior.Color = 16118015

    $worksheet.Columns("A:EL").AutoFit()
