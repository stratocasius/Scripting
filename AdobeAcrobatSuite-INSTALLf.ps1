### Adobe Acrobat 25.001 Suite Update(Task Scheduler) - 12/31/2025
### Includes removal/update of ndOffice Suite. Filename - AdobeAcrobatSuite-INSTALLf.ps1 
$logFilepath = "$($env:ProgramData)\Microsoft\IntuneManagementExtension\Logs\AdobeAcrobatSuite-Update-Transcript.log"
### Start logging
