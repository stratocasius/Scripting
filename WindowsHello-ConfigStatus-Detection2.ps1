### Windows Hello - Last Provider Used - 01/21/2026 
        ...
        if (Test-Path -Path $LastLogin) {
            ...
            if ($LoginMetrics) {
                ...
                switch ($LoginMetrics.LastLoggedOnProvider) {
                    ...
                    '{25CA8579-1BD8-469C-B9FC-6AC45A161C18}' { $exitmessage = "DUO for Windows" }
                    '{cb69481e-8ff7-4039-93ec-0a2729a154a8}' { $exitmessage = "Yubi Key for Windows Authentication"}
