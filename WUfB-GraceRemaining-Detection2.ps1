...
try {
    # Final one-liner for Intune detection (compact)
Write-Output ("PC:{0} | User:{1} | KB:{2} | Grace Ends:{3} | Grace Left:{4}" -f $DeviceName,$UserName,$TargetKB,$graceEndsStr,$remainStr)
