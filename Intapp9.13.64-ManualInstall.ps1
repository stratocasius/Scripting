### Intapp Time 9.13.64 2505 Manual Installer,  Includes Desktop Extension 13.0.167 - 09/16/2025
...
# Define log files
$timeLog = "$env:ProgramData\Microsoft\IntuneManagementExtension\Logs\IntappTime-ManualInstall-Removal.log"
$desktopExtLog = "$env:ProgramData\Microsoft\IntuneManagementExtension\Logs\IntappDesktopExtension-ManualInstall-Uninstall.log"
...
# Start transcript
$installLogFilePath = "C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\IntappTime9.13.64-ManualInstall-Transcript.log"
...
Start-Process -FilePath "msiexec.exe" -ArgumentList "/i `"IntappTimeSetup.msi`" /qn DATAFOLDERUI=%appdata%\Intapp\Time\Data /norestart /l*v `"C:\ProgramData\Microsoft\IntuneManagementExtension\Logs\IntappTime9.13.64-ManualInstall.log`"" -Wait -NoNewWindow
...
Write-Output ("Intapp Time 9.13.64 and Desktop Extension 13.167.177 Manual Install total script runtime: {0} minutes {1} seconds" -f $Duration.Minutes, $Duration.Seconds)
