...
Set-Content -Path "$($env:ProgramData)\Microsoft\AutopilotBranding\JLAutopilotBranding.ps1.tag" -Value "Installed"

# Start logging
Start-Transcript "$($env:ProgramData)\Microsoft\AutopilotBranding\JLAutopilotBranding.log"
...
Copy-Item "$installFolder\JL_Wallpaper_04.png" "C:\Windows\web\wallpaper\Autopilot\JL_Wallpaper_04.png" -Force
