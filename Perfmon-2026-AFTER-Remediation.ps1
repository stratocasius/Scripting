### 03/12/2026 - PerfMon 2026 After
###    Perfmon-2026-AFTER-Remediation.ps1
### Modified:
###  - Writes XML + BLG + CSV directly under:
###  - C:\ProgramData\Microsoft\IntuneManagementExtension\Logs
###  - Imports + starts collector JL-Process-HW-Stats4-AFTER(6hr run - 30sec samples)
...
$xmlPath = Join-Path $basePath "JL-Process-Adobe-HardwareAnalysis-AFTER.xml"
$blgPath = Join-Path $basePath "DataCollector01-AFTER.blg"
$csvPath = Join-Path $basePath "DataCollector01-AFTER.csv"

# Stop collector if running (prevents BLG lock issues)
try { logman stop "JL-Process-HW-Stats4-AFTER" -ets 2>$null | Out-Null } catch {}

# Delete existing collector definition so imports are repeatable
try { logman delete "JL-Process-HW-Stats4-AFTER" 2>$null | Out-Null } catch {}
...
<DataCollectorSet>
  ...
  <PerformanceCounterDataCollector>
    ...
    <Name>DataCollector01-AFTER</Name>

    <!-- File will be DataCollector01-AFTER.blg in OutputLocation -->
    <FileName>DataCollector01-AFTER</FileName>
    ...
    <LatestOutputLocation>$basePath\DataCollector01-AFTER.blg</LatestOutputLocation>
    ...
    <Counter>\Process(Access Experience)\% Processor Time</Counter>
    <Counter>\Process(Access Experience)\IO Data Bytes/sec</Counter>
    <Counter>\Process(Access Experience)\Private Bytes</Counter>
    ...
    <Counter>\Process(Copilot.exe)\% Processor Time</Counter>
    <Counter>\Process(Copilot.exe)\IO Data Bytes/sec</Counter>
    <Counter>\Process(Copilot.exe)\Private Bytes</Counter>
    ...
    <Counter>\Process(M365Copilot)\% Processor Time</Counter>
    <Counter>\Process(M365Copilot)\IO Data Bytes/sec</Counter>
    <Counter>\Process(M365Copilot)\Private Bytes</Counter>
    <Counter>\Process(ms-teams)\% Processor Time</Counter>
    <Counter>\Process(ms-teams)\IO Data Bytes/sec</Counter>
    <Counter>\Process(ms-teams)\Private Bytes</Counter>
    ...
    <Counter>\Process(msedgewebview2)\% Processor Time</Counter>
    <Counter>\Process(msedgewebview2)\IO Data Bytes/sec</Counter>
    <Counter>\Process(msedgewebview2)\Private Bytes</Counter>
    ...
    <Counter>\Process(ResearchMonitor Agent)\% Processor Time</Counter>
    <Counter>\Process(ResearchMonitor Agent)\IO Data Bytes/sec</Counter>
    <Counter>\Process(ResearchMonitor Agent)\Private Bytes</Counter>
    <Counter>\Process(spoolsv.exe)\% Processor Time</Counter>
    <Counter>\Process(spoolsv.exe)\IO Data Bytes/sec</Counter>
    <Counter>\Process(spoolsv.exe)\Private Bytes</Counter>
...
$logmanImport = "logman import -n JL-Process-HW-Stats4-AFTER -xml `"$xmlPath`""
Invoke-Expression $logmanImport

$logmanStart = "logman start JL-Process-HW-Stats4-AFTER"
