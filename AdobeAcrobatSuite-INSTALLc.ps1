### Adobe Acrobat 25.001 Suite for Autopilot(Company Portal) - 12/18/2025
### Includes removal/update of ndOffice Suite. Filename - AdobeAcrobatSuite-INSTALLc.ps1 
...
Add-MpPreference -ExclusionProcess gccustomhook.exe
Write-Output "gccustomhook.exe added to CFA exclusion list."

$setupPath = "C:\jltools\AdobeAcrobatSuite\setup.exe"
if (Test-Path $setupPath) {
    Set-Location -Path "C:\jltools\AdobeAcrobatSuite"
    Start-Process "C:\jltools\AdobeAcrobatSuite\setup.exe" -Wait ### removed  -ArgumentList "--silent"
...
Remove-MpPreference -ExclusionProcess gccustomhook.exe
