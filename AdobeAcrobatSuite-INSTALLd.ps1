...
$logFilepath = "$($env:ProgramData)\Microsoft\IntuneManagementExtension\Logs\AdobeAcrobatSuite-Company Portal-Transcript.log"
### Start logging
...
if ($ndFound) {
    $uninstallExe = "ndOfficeSetup401.exe"
...
if (Test-Path $setupPath) {
    #Set-Location -Path "C:\jltools\AdobeAcrobatSuite"
    Start-Process "setup.exe" -Wait ### removed  -ArgumentList "--silent"
